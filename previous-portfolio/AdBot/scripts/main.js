...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_slick_carousel__ = __webpack_require__(9);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  init: function init() {
    ...
    var string = document.querySelectorAll('.tab-articles__h3');
    lookAllElements(string, 50);

    var string2 = document.querySelectorAll('.tab-articles__content');
    lookAllElements(string2, 130);
