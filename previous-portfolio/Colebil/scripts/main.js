...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__autoload_lazy_load_js__ = __webpack_require__(3);
...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_slick_carousel_slick_slick__ = __webpack_require__(8);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  init: function init() {
    ...
    $('#produs').on('click', function (event) {
      event.preventDefault();
    ...
    $('#produs-desc').on('click', function (event) {
      event.preventDefault();
      var id  = $(this).attr('href'),
        top = $(id).offset().top;
      $('body,html').animate({scrollTop: top}, 1500);
    ...
    $('.tab-labels').on('click', 'label', (function() {
      ...
      if (!$(this).hasClass('active-label')) {
        $('.tab-labels label.active-label').removeClass('active-label');
        $('.tab-content .active-tab').removeClass('active-tab');
        $(this).addClass('active-label');
        $('.tabs__faq').height($($('.tab-content').children('.tab-item')[i]).height());
    ...
    $('.tabs__faq__left').on('click', '.tabs__interbar', (function() {
      var i = $(this).attr('value');
      $('.tabs__faq').addClass('tabs__faq__disabled');
      if (!$(this).hasClass('active-label')) {
        $('.tab-content .active-tab').removeClass('active-tab');
    ...
    $('.tabs__faq__right').on('click', '.tabs__interbar', (function() {
      var i = $(this).attr('value');
      $('.tabs__faq').addClass('tabs__faq__disabled');
      if (!$(this).hasClass('active-label')) {
        $('.tab-content .active-tab').removeClass('active-tab');
